                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td class="name"><img src="assets/img/user1.jpg" alt="image"> Atony Rony</td>
                                <td>
                                    <a href="#" class="d-inline-block text-warning mr-2" data-bs-toggle="tooltip" data-placement="top" title="hello@tomhardy.com"><i class='bx bx-envelope'></i></a>
                                    <a href="#" class="d-inline-block text-success mr-2" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class='bx bx-edit'></i></a>
                                    <a href="#" class="d-inline-block text-danger" data-bs-toggle="tooltip" data-placement="top" title="Delete"><i class='bx bx-trash'></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="name"><img src="assets/img/user2.jpg" alt="image"> Tom Hardy</td>
                            ...
                            <tr>
                                <td class="name"><img src="assets/img/user3.jpg" alt="image"> Colin Firth</td>
                                <td>
                                    <a href="#" class="d-inline-block text-warning mr-2" data-bs-toggle="tooltip" data-placement="top" title="hello@colinfirth.com"><i class='bx bx-envelope'></i></a>
                                    <a href="#" class="d-inline-block text-success mr-2" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class='bx bx-edit'></i></a>
                                    <a href="#" class="d-inline-block text-danger" data-bs-toggle="tooltip" data-placement="top" title="Delete"><i class='bx bx-trash'></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="name"><img src="assets/img/user4.jpg" alt="image"> Jude Law</td>
                                <td>
                                    <a href="#" class="d-inline-block text-warning mr-2" data-bs-toggle="tooltip" data-placement="top" title="hello@judelaw.com"><i class='bx bx-envelope'></i></a>
                                    <a href="#" class="d-inline-block text-success mr-2" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class='bx bx-edit'></i></a>
                                    <a href="#" class="d-inline-block text-danger" data-bs-toggle="tooltip" data-placement="top" title="Delete"><i class='bx bx-trash'></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="name"><img src="assets/img/user5.jpg" alt="image"> Idris Elba</td>
                                <td>
                                    <a href="#" class="d-inline-block text-warning mr-2" data-bs-toggle="tooltip" data-placement="top" title="hello@idriselba.com"><i class='bx bx-envelope'></i></a>
                                    <a href="#" class="d-inline-block text-success mr-2" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class='bx bx-edit'></i></a>
                                    <a href="#" class="d-inline-block text-danger" data-bs-toggle="tooltip" data-placement="top" title="Delete"><i class='bx bx-trash'></i></a>
                                </td>
                            </tr>
            ...
            <div class="card-body">
                <ul>
                    <li class="single-product">
                        ...
                        <a href="#" class="view-link d-inline-block" data-bs-toggle="tooltip" data-placement="top" title="View Details"><i class='bx bxs-arrow-to-right'></i></a>
                    </li>
